  ...
  >
    <section class="flex flex-col w-full max-w-lg">
      ...
      <p class="text-xl text-gray-400 w-full max-w-lg">
        You can ask your questions / propose a new feature / file a bug with our community and
        mainters.
      </p>
    </section>
    <section class="flex flex-col w-full max-w-xl rounded-lg overflow-hidden">
      <iframe
        class="w-full h-64"
        :src="
          'https://discord.com/widget?id=1044804142461362206&theme=' + (isDark ? 'dark' : 'light')
        "
