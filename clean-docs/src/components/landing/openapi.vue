  ...
  >
    ...
    <header class="flex flex-col gap-3 w-full">
      ...
      <p class="text-xl leading-normal text-gray-400 w-full max-w-lg mb-4">
        Elysia generates OpenAPI 3.0 specs automatically to integrate with various tools across
        multiple languages
      </p>
      <p class="text-xl leading-normal text-gray-400 w-full max-w-lg mb-4">
        Thanks to OpenAPI compliance, Elysia can generate Swagger in one line with the Swagger
        plugin.
      </p>
    </header>
  </article>
