...
import { getRoutePathParts, normalizeRoutePath, splitRoutePathParts } from './normalizeRoutePath'
import { absolutePathToRelativePath, absolutePathToRoutePath, RoutePage } from './RoutePage'
...
export class RouteService {
  ...
  private constructor(
    ...
    this.#langs = (userConfig?.locales ?? userConfig?.themeConfig?.locales ?? []).map(
      (item) => item.lang,
    )
