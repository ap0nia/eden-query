...
export const CSR_CLIENT_ENTRY = path.join(PACKAGE_ROOT, 'dist', 'runtime', 'csrClientEntry.js')

export const SSR_CLIENT_ENTRY = path.join(PACKAGE_ROOT, 'dist', 'runtime', 'ssrClientEntry.js')

export const SSR_SERVER_ENTRY = path.join(PACKAGE_ROOT, 'dist', 'runtime', 'ssrServerEntry.js')
...
export const TEMP_DIR = path.join(process.cwd(), 'node_modules', RSPRESS_TEMP_DIR)
