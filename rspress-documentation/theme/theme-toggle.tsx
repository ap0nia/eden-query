...
export function ThemeToggle() {
  ...
  return (
    <>
      ...
      >
        <span className="swap-on fill-current icon-[material-symbols--light-mode-outline-rounded]"></span>
        <span className="swap-off fill-current icon-[material-symbols--dark-mode-outline-rounded]"></span>
      </button>
    </>
  )
}
