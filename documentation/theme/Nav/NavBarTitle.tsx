...
export const NavBarTitle = () => {
  ...
  const logo = useMemo(() => {
    ...
    if (typeof rawLogo === 'string') {
      return <img src={normalizeImagePath(rawLogo)} alt="logo" id="logo" className="rspress-logo" />
    }
  ...
  return (
    <div className={`${styles['navBarTitle']}`}>
      <Link
        ...
        className="flex h-full w-full items-center text-base font-semibold transition-opacity duration-300 hover:opacity-60"
      >
