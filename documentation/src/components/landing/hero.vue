...
<template>
  ...
  <div class="relative h-[calc(100vh-64px)] flex items-center">
    <!-- Colorful rays of light -->
    <Ray class="absolute h-5/6 -top-1/4 pointer-events-none opacity-35 dark:opacity-50" />

    <!-- Spotlight -->
    <div class="absolute -top-3/4 h-full w-full pointer-events-none opacity-25 gradient"></div>

    <header class="absolute h-full w-full flex flex-col justify-center items-center">
      <img
        src="/assets/elysia_v.webp"
        alt="Curved text logo that displays 'Elysia.js'"
        class="max-w-[40ch] w-full object-contain object-left md:object-center mr-auto md:mr-0"
        style="aspect-ratio: 1.5 / 1"
      />

      <h1
        class="relative text-5xl md:text-6xl md:leading-tight font-bold md:text-center leading-tight text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary mb-6"
      >
        <span>Ergonomic Framework for Humans</span>
        <span
          class="absolute w-10 md:w-12 h-10 md:h-12 bottom-0 mb-4 ml-2 md:ml-0 md:mb-10 text-secondary"
        >
