...
// import type { TwoslashFloatingVueRendererOptions } from './renderer-floating-react'

declare function rspressPluginTwoslash(options?: RspressPluginTwoslashOptions): RspressPlugin
...
export interface RspressPluginTwoslashOptions
